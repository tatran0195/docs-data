...
```psj
ImportSTDFile(str strPath, int iImportType, double dFaceAngle, double dEdgeAngle)
```
...
- A String specifying std result file path.
...
```psj
ImportSTDFile("path/to/the/file", 1, 60.0, 60.0)
```