---
id: Home-ImportResults-ImportMesh-ADVC
...
Macro: [ImportAdxToPost](../../macro/home/ImportAdxToPost)

Ribbon: <menuselection>Home &#187; ImportResults &#187; ImportMesh &#187; ADVC</menuselection>

## Inputs

### `strPath`

- A _String_ specifying an ADVC file (\*.adx file) which will be used for importing.
