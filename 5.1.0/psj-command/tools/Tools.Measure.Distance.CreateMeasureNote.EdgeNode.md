---
id: Tools-Measure-Distance-CreateMeasureNote-EdgeNode
title: Tools.Measure.Distance.CreateMeasureNote.EdgeNode()
author: TechnoStar Co., Ltd.
authorURL: https://www.e-technostar.com/
description: Create a Measure Note for Measure > Distance > Edge-Node function.
---

## Description

Create a Measure Note for Measure > Distance > Edge-Node function.
## Syntax

```psj
Tools.Measure.Distance.CreateMeasureNote.EdgeNode(...)
```

Macro: [CreateMeasureNoteDistanceByEdge_Node]

Ribbon: <menuselection>Tools &#187; Measure &#187; Distance &#187; CreateMeasureNote &#187; EdgeNode</menuselection>
