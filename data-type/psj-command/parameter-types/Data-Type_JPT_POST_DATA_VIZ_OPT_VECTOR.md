---
title: POST_DATA_VIZ_OPT_VECTOR
id: POST_DATA_VIZ_OPT_VECTOR
---

## Description

A data type is used to set up the result settings for displaying the vector.
...
- A _Boolean_ specifying whether to display the arrow vector.
...
- A _Boolean_ specifying whether to display the vector at node inside a solid.
- The default value is _False_.
...
- A _Boolean_ specifying whether to display all vectors in the same length.
- The default value is _False_.
